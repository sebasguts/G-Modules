#############################################################################
##  
##  PackageInfo.g for the package `G-Modules'                    Mohamed Barakat
...
# 
ArchiveURL := Concatenation( "http://G-Modules.math.rwth-aachen.de/~barakat/G-Modules-project/G-Modules/G-Modules-", ~.Version ),
...
#
README_URL := 
  "http://G-Modules.math.rwth-aachen.de/~barakat/G-Modules-project/G-Modules/README.G-Modules",
PackageInfoURL := 
  "http://G-Modules.math.rwth-aachen.de/~barakat/G-Modules-project/G-Modules/PackageInfo.g",
...
PackageWWWHome := "http://G-Modules.math.rwth-aachen.de/index.php/core-packages/G-Modules-package",
#               
...
PackageDoc := rec(
  ...
  Archive := 
    "http://G-Modules.math.rwth-aachen.de/~barakat/G-Modules-project/G-Modules/G-Modules.tar.gz",
...
BannerString := Concatenation( 
  ...
  "   ", ~.Persons[3].FirstNames, " ", ~.Persons[3].LastName,
        " (", ~.Persons[3].WWWHome, ")\n",
  "Type:\n",
  "  ?G-Modules:                   ## for the contents of the manual\n",
  "  ?G-Modules:x                  ## for chapter/section/topic x\n",
